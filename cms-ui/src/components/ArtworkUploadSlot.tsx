...
export const ArtworkUploadSlot: React.FC<ArtworkUploadSlotProps> = ({
  ...
  React.useEffect(() => { setPreviewUrl(currentUrl); }, [currentUrl]);
            ...
            <div className='relative group w-full flex flex-col items-center'>
              <img
                ...
                onError={(e) => {
                  ...
                  target.onerror = null;
                  target.src = 'data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100"><rect fill="%23374151" width="100" height="100"/><text x="50" y="55" text-anchor="middle" fill="%239CA3AF" font-size="12">No Image</text></svg>';
                }}
              />
