...
from app.models.models import Episode, Season
from app.schemas.schemas import EpisodeCreate, EpisodeResponse, EpisodeUpdate
...
async def create_episode(
    ...
    try:
        ...
        await db.rollback()
        raise HTTPException(status_code=409, detail="Duplicate episode: content_group and language combination already exists in this season.")
