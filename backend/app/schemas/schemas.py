...
class ValidationReport(BaseModel):
    ...
    issues_by_show: dict[str, list[ValidationIssue]] = Field(default_factory=dict)
...
class CatalogShow(BaseModel):
    ...
    trailers: list[CatalogTrailer] = Field(default_factory=list)  # Separated Season 0 trailers
    total_episodes: int
